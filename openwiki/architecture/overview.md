...
Para documentação detalhada de deploy e operações, ver [operations/deploy-guide.md](/openwiki/operations/deploy-guide.md) e [operations/deploy-checklist.md](/openwiki/operations/deploy-checklist.md).