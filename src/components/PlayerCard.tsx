...
import { Player, PlayerPosition, User as UserType, CategoryTransition } from '../types/domain';
import { FAVORITE_TEAMS, POSITION_LABELS, CATEGORY_LABELS, STATUS_COLORS, STATUS_LABELS, LINE_ATTRIBUTES, GOALKEEPER_ATTRIBUTES } from '../types/ui';
        ...
        <div className="flex-1 flex flex-col justify-start pt-1.5 w-full">
          ...
          {faceIndex === 0 && (
            <div className="flex-1 flex flex-col justify-between animate-fade-in">
              ...
              <div className="flex flex-col items-center justify-center -mt-1 mb-1 relative -translate-y-[10%]">
                <div
